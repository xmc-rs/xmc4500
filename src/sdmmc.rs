...
pub struct RegisterBlock {
    ...
    _reserved31: [u8; 0x78],
    #[doc = "0xf0 - SPI Interrupt Support Register"]
    pub spi: SPI,
    _reserved32: [u8; 0x08],
...
pub mod debug_sel;
#[doc = "SPI (rw) register accessor: SPI Interrupt Support Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spi::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`spi`]
module"]
