...
#[doc = "Debug Selection Register"]
pub mod debug_sel;
#[doc = "SPI Interrupt Support Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi](spi) module"]
pub type SPI = crate::Reg<u32, _SPI>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SPI;
#[doc = "`read()` method returns [spi::R](spi::R) reader structure"]
impl crate::Readable for SPI {}
#[doc = "`write(|w| ..)` method takes [spi::W](spi::W) writer structure"]
impl crate::Writable for SPI {}
#[doc = "SPI Interrupt Support Register"]
pub mod spi;
