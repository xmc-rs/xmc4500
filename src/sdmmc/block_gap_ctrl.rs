...
pub type SPI_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u8, BLOCK_GAP_CTRL_SPEC, SPI_MODE_A, O>;
impl<'a, const O: u8> SPI_MODE_W<'a, O> {
    #[doc = "SD mode"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mode(&mut self) -> SPI_MODE_W<4> {
        SPI_MODE_W::new(self)
    }
