...
pub type CFSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, CFSEL_A>;
impl<'a, REG, const O: u8> CFSEL_W<'a, REG, O>
where
...
pub type CFMOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O, CFMOD_A>;
