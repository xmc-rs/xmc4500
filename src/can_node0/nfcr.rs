...
impl From<Cfsel> for u8 {
    #[inline(always)]
    fn from(variant: Cfsel) -> Self {
        variant as _
    }
}
...
impl CfselR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<Cfsel> {
        match self.bits {
            0 => Some(Cfsel::Value1),
            _ => None,
        }
...
pub type CfselW<'a, REG> = crate::FieldWriter<'a, REG, 3, Cfsel>;
impl<'a, REG> CfselW<'a, REG>
where
...
impl CfmodR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Cfmod> {
        match self.bits {
            0 => Some(Cfmod::Value1),
            1 => Some(Cfmod::Value2),
            2 => Some(Cfmod::Value3),
...
pub type CfmodW<'a, REG> = crate::FieldWriter<'a, REG, 2, Cfmod>;
