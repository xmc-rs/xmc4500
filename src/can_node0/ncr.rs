...
impl From<Susen> for bool {
    #[inline(always)]
    fn from(variant: Susen) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SUSEN` reader - Suspend Enable"]
pub type SusenR = crate::BitReader<Susen>;
impl SusenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Susen {
        match self.bits {
            false => Susen::Value1,
            true => Susen::Value2,
        }
...
pub type SusenW<'a, REG> = crate::BitWriter<'a, REG, Susen>;
impl<'a, REG> SusenW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "An OCDS suspend trigger is ignored by the CAN node."]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Susen::Value1)
    }
    #[doc = "An OCDS suspend trigger disables the CAN node: As soon as the CAN node becomes bus-idle or bus-off, bit INIT is internally forced to 1 to disable the CAN node. The actual value of bit INIT remains unchanged."]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Susen::Value2)
    }
}
impl R {
