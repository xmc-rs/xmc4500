...
pub type SUSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, SUSEN_A>;
impl<'a, REG, const O: u8> SUSEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "An OCDS suspend trigger is ignored by the CAN node."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn susen(&mut self) -> SUSEN_W<NCR_SPEC, 8> {
        SUSEN_W::new(self)
    }
